...
public class ToolsDataTable {
  public static ToolsTable<RuleEnum,TerminalEnum> createToolsTable() {
      EnumSet<RuleEnum> spawns = EnumSet.of(RuleEnum.star,RuleEnum.sharp,RuleEnum.mod,RuleEnum.comment,RuleEnum._if,RuleEnum.pipe,RuleEnum.dot,RuleEnum.ropt,RuleEnum.doc,RuleEnum.id,RuleEnum.le,RuleEnum.quote,RuleEnum.minus,RuleEnum.lt,RuleEnum.comma,RuleEnum.value,RuleEnum.eq,RuleEnum.gt,RuleEnum.semicolon,RuleEnum.lpar,RuleEnum.eol,RuleEnum.slash,RuleEnum._return,RuleEnum._throw,RuleEnum.ge,RuleEnum.at,RuleEnum.lcurl,RuleEnum.bang,RuleEnum.colon,RuleEnum.rcurl,RuleEnum.plus,RuleEnum.rpar,RuleEnum._while,RuleEnum.assign,RuleEnum.text,RuleEnum.ne,RuleEnum.lopt);
