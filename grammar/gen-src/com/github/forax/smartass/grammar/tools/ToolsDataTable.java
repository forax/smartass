...
public class ToolsDataTable {
  public static ToolsTable<RuleEnum,TerminalEnum> createToolsTable() {
      EnumSet<RuleEnum> spawns = EnumSet.of(RuleEnum._return,RuleEnum.ne,RuleEnum.comment,RuleEnum.rpar,RuleEnum.rcurl,RuleEnum.ge,RuleEnum._if,RuleEnum._throw,RuleEnum.slash,RuleEnum.lt,RuleEnum.minus,RuleEnum.id,RuleEnum.semicolon,RuleEnum.le,RuleEnum.ropt,RuleEnum.dot,RuleEnum.comma,RuleEnum.lopt,RuleEnum.star,RuleEnum.pipe,RuleEnum.colon,RuleEnum.assign,RuleEnum.eol,RuleEnum.lpar,RuleEnum.lcurl,RuleEnum.at,RuleEnum.gt,RuleEnum.mod,RuleEnum.text,RuleEnum.bang,RuleEnum.value,RuleEnum.eq,RuleEnum.plus,RuleEnum._while);
